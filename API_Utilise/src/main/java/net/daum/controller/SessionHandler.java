...
public class SessionHandler implements HttpSessionListener {
	...
	private static final Map<String, HttpSession> sessions = new ConcurrentHashMap<>(); //ConcurrentHashMap은 HashMap과달리 Null를 받아들이지않는다.
	...
	public void sessionDestroyed(HttpSessionEvent se) { //세션이 삭제되거나 브라우저를 나갈때 이벤트발생
		...
		System.out.println("현재 남아있는 세션 수 :"+getCount());
